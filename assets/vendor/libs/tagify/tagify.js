!(function () {
                                ...
                                onFocusBlur(t) {
                                    ...
                                    if (!r && !l)
                                        if (((this.state.hasFocus = "focus" == a && +new Date()), this.toggleFocusClass(this.state.hasFocus), "mix" != e.mode)) {
                                            ...
                                            "focus" == a ? this.trigger("focus", o) : "blur" == t.type && (this.trigger("blur", o), this.loading(!1), this.dropdown.hide(), (this.state.dropdown.visible = void 0), this.setStateSelection());
                                },
                                                ...
                                                case "Backspace":
                                                    ...
                                                    if (
                                                        ((d || g) && 1 == r.anchorNode.nodeType
                                                            ? (a = 0 == r.anchorOffset ? (d ? c[0] : null) : c[Math.min(c.length, r.anchorOffset) - 1])
                                                            : d
                                                        ...
                                                        (y = setTimeout(() => {
                                                            ...
                                                            if (e.length >= p.length && i)
                                                                if (v.call(this, i) && !i.hasAttribute("readonly")) {
                                                                    if ((this.removeTags(i), this.fixFirefoxLastTagNoCaret(), 2 == this.DOM.input.children.length && "BR" == this.DOM.input.children[1].tagName))
                                ...
                                onMixTagsInput(t) {
                                    ...
                                    setTimeout(() => {
                                        this.update({ withoutChangeEvent: !0 }),
                                            this.trigger("input", g({}, this.state.tag, { textContent: this.DOM.input.textContent })),
                                ...
                                onClickScope(t) {
                                    ...
                                    if (t.target != this.DOM.scope) {
                                        if (!t.target.classList.contains(e.classNames.tagX))
                                            return i
                                                ? (this.trigger("click", { tag: i, index: this.getNodeIndex(i), data: this.tagData(i), event: t }),
                                                ...
                                                : void (t.target == this.DOM.input && ("mix" == e.mode && this.fixFirefoxLastTagNoCaret(), s > 500)
                                                      ...
                                                      : "select" == e.mode && !this.state.dropdown.visible && this.dropdown.show());
                                ...
                                onEditTagBlur(t) {
                                    if ((this.state.hasFocus || this.toggleFocusClass(), this.DOM.scope.contains(t))) {
                                        ...
                                        if (n)
                                            if (l) {
                                                if (
                                                    ((e = this.hasMaxTags()), (i = g({}, r, { [s.tagTextProp]: this.trim(n), __isValid: d })), s.transformTag.call(this, i, r), !0 !== (d = (!e || !0 === r.__isValid) && this.validateTag(i)))
                                                ) {
                                                    if ((this.trigger("invalid", { data: i, tag: a, message: d }), s.editTags.keepInvalid)) return;
                        ...
                        (M.prototype = {
                            ...
                            applySettings(t, i) {
                                ...
                                if (
                                    ...
                                    void 0 === s.dropdown.includeSelectedTags && (s.dropdown.includeSelectedTags = s.duplicates),
                            ...
                            editTag(t, e) {
                                ...
                                if (s) {
                                    if (!(n instanceof Object && "editable" in n) || n.editable)
                                        return (
                                            (n = this.tagData(t, { __originalData: g({}, n), __originalHTML: t.cloneNode(!0) })),
                            ...
                            editTagToggleValidity(t, e) {
                                ...
                                if ((e = e || this.tagData(t)))
                                    return (i = !("__isValid" in e) || !0 === e.__isValid) || this.removeTagsFromValue(t), this.update(), t.classList.toggle(this.settings.classNames.tagNotAllowed, !i), e.__isValid;
                            ...
                            injectAtCaret(t, e) {
                                return !(e = e || this.state.selection?.range) && t
                                    ...
                                    : ("string" == typeof t && (t = document.createTextNode(t)), e.deleteContents(), e.insertNode(t), this.setRangeAtStartEnd(!1, t), this.updateValueByDOMTags(), this.update(), this);
                            },
                            input: {
                                set() {
                                    let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
                            ...
                            addTags(t, e, i) {
                                ...
                                return (
                                    ...
                                    this.appendTag(o),
                                    this.update(),
                                    t.length && e && (this.input.set.call(this, a.createInvalidTags ? "" : n.join(a._delimiters)), this.setRangeAtStartEnd()),
    ...
    var a = window;
    for (var n in s) a[n] = s[n];
    s.__esModule && Object.defineProperty(a, "__esModule", { value: !0 });
})();
