                                                        ...
                                                        "".split(/.?/).length
                                                            ? function (e, n) {
                                                                  ...
                                                                  for (
                                                                      ...
                                                                      (u = f.call(y, r)) &&
                                                                      !((s = y.lastIndex) > d && (c.push(r.slice(d, u.index)), u.length > 1 && u.index < r.length && h.apply(c, u.slice(1)), (l = u[0].length), (d = s), c.length >= o));
                                                            ...
                                                            "form" === this.element.tagName && this.element.setAttribute("enctype", "multipart/form-data"),
                                                                this.element.classList.contains("dropzone") &&
                                                                    ...
                                                                    this.element.appendChild(
                                                                        i.createElement('<div class="dz-default dz-message"><button class="dz-button" type="button">'.concat(this.options.dictDefaultMessage, "</button></div>"))
                                                                    ),
                ...
                for (var n = this, r = 0; r < e.length; r++)
                    for (var i = e[r], o = Math.round(Math.min(60, Math.max(6, i.size / 1e5))), a = 0; a < o; a++) {
                        ...
                        setTimeout(
                            (function (e, r, i) {
                                return function () {
                                    (e.upload = { progress: (100 * (i + 1)) / r, total: e.size, bytesSent: ((i + 1) * e.size) / r }),
